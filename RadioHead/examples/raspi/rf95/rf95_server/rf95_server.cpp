...
//RFM95 Configuration
#define RFM95_FREQUENCY  437.00
#define RFM95_TXPOWER 23
...
int main (int argc, const char* argv[] )
{
  ...
  gpioSetMode(RFM95_RST_PIN, PI_OUTPUT);
  gpioWrite(RFM95_RST_PIN,PI_ON);
  delay(10);
...
void resetRF95()
{
  gpioWrite(RFM95_RST_PIN,PI_OFF);
  delay(1);
  gpioWrite(RFM95_RST_PIN,PI_ON);
  delay(5);
